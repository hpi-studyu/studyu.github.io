...
components](https://supabase.com/docs/guides/self-hosting) to a single port which simplifies self-hosting.
...
Access to all components requires authentication. This is done via the [Supabase JWT implementation](https://supabase.com/docs/learn/auth-deep-dive/auth-deep-dive-jwts).
