...
- supabase-db (the actual database)
- supabase-realtime
- supabase-imgproxy
- supabase-studio
- supabase-kong
...
We have developed a StudyU CLI tool to streamline the process of setting up StudyU. Instructions are provided in the
`docker` directory within the [StudyU GitHub repository](https://github.com/hpi-studyu/studyu/blob/dev/docker/README.md).
