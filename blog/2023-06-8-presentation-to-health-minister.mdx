...
image: /img/health_minister.jpg
---

import Image from '@theme/IdealImage';
import thumbnail from '/img/blog/health_minister.jpg';
...
Hasso Plattner Institute (HPI).<!-- truncate --> In a engaging discussion with senior researcher Dr. Stefan Konigorski,
